...
export const About = () => {
  return (
    <>
      <div className='min-h-screen max-h-screen w-full md:flex md:backdrop-blur-3xl'>
      <div className='md:w-1/2 pt-12 pl-20'>
            <div className="relative flex flex-col right-52">
                <img src={Image} className="w-full scale-x-[-1.2] scale-y-[1.2] z-50 opacity-30 md:opacity-100" />
                <div className="relative bottom-[50rem] right-[20rem] w-[70rem] h-[30rem]">
                    <img src={Background} className="w-full opacity-25 md:opacity-70 blur-3xl " />
                </div>
            </div>
        </div>
        <div className='md:w-1/2 my-auto md:pl-12 min-h-screen -mt-[56rem] md:mt-0 flex flex-col z-[100]'>
            <div className="mt-0 flex justify-end">
                <h1 className="font-ld text-[8rem]">01</h1>
            </div>
            <div className="flex flex-col gap-0 leading-none z-50 md:-ml-40 md:pr-20 ">
