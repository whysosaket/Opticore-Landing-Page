...
const Navbar = () => {
  return (
    <div className="relative">
      <div className="absolute flex z-50 justify-between px-6 align-middle w-5/6 h-16 rounded-[8rem] bg-white/10 top-4 left-1/2 transform -translate-x-1/2">
        <h1 className="my-auto font-crr text-2xl"><span className="text-p1">O</span>CORE</h1>
        <div className="my-auto flex gap-3 font-semibold">
            {
